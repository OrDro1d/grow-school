...
import AddToWishListBtn from '@/components/UI/main/buttons/AddToWishListBtn';
import type { ICourseClient } from '@/types/Course.interface';

export default function CourseCard({ courseData }: { courseData: ICourseClient }) {
  return (
    <Link href='#'>
      <section className='flex flex-col p-4 transition-all bg-white border-2 border-gray-200 shadow-lg rounded-2xl hover:border-skiey w-65 shadow-black/10 hover:shadow-skiey/20'>
        ...
        <div className='mt-2'>
          <div className='h-24'>
            <h1 className='text-sm font-medium break-words'>{courseData.title}</h1>
