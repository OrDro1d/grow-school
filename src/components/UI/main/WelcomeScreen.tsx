    ...
    >
      ...
      <div className="lg:flex-col flex w-fit items-center *:my-2">
        ...
        <div className="flex gap-2 w-fit">
          <WelcomeScreenBtn href="#all-courses">{PATHS.ALL_COURSES.pathname}</WelcomeScreenBtn>
          <WelcomeScreenBtn href="#recommended-courses">PATHS.</WelcomeScreenBtn>
          <WelcomeScreenBtn href={cookieStore.has('userId') ? '/course/new' : '/auth/signup'}>
            Создать курс
          </WelcomeScreenBtn>
          <WelcomeScreenBtn href="/landing">О нас</WelcomeScreenBtn>
        </div>
      </div>
    </header>
  )
