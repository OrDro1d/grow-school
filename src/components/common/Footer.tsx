  ...
  return (
    <footer className={`flex justify-evenly text-gray-600 bg-gray-200 p-16 text-sm ${className}`}>
      ...
      <div className='flex flex-col gap-2 *:transition-all'>
        ...
        <Link className='hover:text-skiey' href={PATHS.MAIN_COURSES.URL}>
          {PATHS.MAIN_COURSES.pathname}
        </Link>
        <Link className='hover:text-skiey' href={PATHS.ALL_COURSES.URL}>
          {PATHS.ALL_COURSES.pathname}
        </Link>
        <Link className='hover:text-skiey' href='#'>
          Найти курс
        </Link>
        <Link className='hover:text-skiey' href={PATHS.NEW_COURSE.URL}>
          {PATHS.NEW_COURSE.pathname}
        </Link>
        <Link className='hover:text-skiey' href='#'>
          О создании курсов
        </Link>
        <Link className='hover:text-skiey' href={PATHS.ABOUT.URL}>
